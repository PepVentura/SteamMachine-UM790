...
//=============================================================================
// LENGÜETA DE UNIÓN CON LA BANDEJA — ELIMINADA
//
// PEDIDO POR EL USUARIO (2026-08-17, marcado en una captura):
// "sobran estos soportes, no son necesarios" — el panel trasero
// queda sujeto solo por los tornillos a las paredes laterales
// (rearWallScrewHoles(), M3, ya verificados). Eliminados
// rearBridgeTab(), rearBridgeTabs() y rearBridgeScrewHoles().
//
// PENDIENTE DE REVISAR POR EL USUARIO: la bandeja
// (openscad/parts/01_bandeja/base.scad) todavía tiene los insertos
// correspondientes (trayRearBridgeInserts(), trayRearBridgeInsertPads())
// — no se han tocado, no se pidieron explícitamente, pero ahora no
// tienen ningún tornillo real que rosque en ellos. No afecta a la
// integridad de la bandeja (siguen siendo material sólido de apoyo),
// pero si se quiere limpiar del todo, avisar para quitarlos también.
//=============================================================================
