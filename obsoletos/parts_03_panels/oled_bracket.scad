...
// Fecha    : 2026-08-22
//
// ⚠️ OBSOLETO (2026-09-08, confirmado por el usuario: "solo fue un
// modelo para analizar pero está descartado") — sustituido por
// fijación directa con 4 tornillos a través de
// openscad/parts/03_panels/lower_panel.scad (oledMountHoles(), ya
// presente e implementada desde antes de esta brida). La brida nunca
// llegó a tener sus bosses de anclaje realmente construidos en
// lower_panel.scad (oledInsertBosses(), mencionado más abajo, nunca
// se llegó a escribir) — quedó en pieza de estudio, sin usarse.
// Movido a obsoletos/ (ver obsoletos/README.md) — conservado como
// referencia histórica, no imprimir. Ver CHANGELOG [1.5.5].
//
